/*
* Code copied from https://github.com/Pedro-Pathing/PedroPathing/blob/FusionLocalizer/core/src/main/java/com/pedropathing/localization/FusionLocalizer.java
* Written by https://github.com/junkjunk123
*/
...
import org.firstinspires.ftc.teamcode.Util.MatrixUtilEx;
...
public class FusionLocalizer implements Localizer {
    ...
    public FusionLocalizer(
        ...
        this.P = MatrixUtilEx.diag(P[0], P[1], P[2]);
        this.Q = MatrixUtilEx.diag(processVariance[0], processVariance[1], processVariance[2]);
        this.R = MatrixUtilEx.diag(measurementVariance[0], measurementVariance[1], measurementVariance[2]);
    ...
    private void updateCovariance(double dt) {
        Matrix G = MatrixUtilEx.createRotation(getPose().getHeading()).multiply(dt);
    ...
    public void addMeasurement(Pose measuredPose, long timestamp) {
        ...
        Matrix I = MatrixUtilEx.identity(3);
        Matrix IK = I.minus(K);
        ...
        for (NavigableMap.Entry<Long, Pose> entry :
            ...
            Matrix G = MatrixUtilEx.createRotation(prevPose.getHeading()).multiply(dt);
    ...
    private Matrix invert(Matrix m) {
        ...
        Matrix I = MatrixUtilEx.identity(m.getRows());
